...
export default function NotificationCenter() {
  ...
  return <div className="relative">
    ...
    {open && <><button aria-label="Đóng thông báo" className="fixed inset-0 z-40 cursor-default" onClick={() => setOpen(false)} /><div className="fixed left-3 right-3 top-20 z-50 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-slate-600 dark:bg-[#404040] md:left-[calc(var(--scholar-sidebar-width,288px)+12px)] md:right-auto md:top-auto md:bottom-3 md:w-[390px]" onClick={(e) => e.stopPropagation()}>
